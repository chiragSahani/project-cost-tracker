/*
  # Project Cost Tracker Schema

  1. New Tables
    - `items`: Stores project items with costs
    - `other_costs`: Stores miscellaneous project expenses
...
BEGIN
  ...
  DROP POLICY IF EXISTS "Users can view their own other costs" ON other_costs;
  DROP POLICY IF EXISTS "Users can create their own other costs" ON other_costs;
  DROP POLICY IF EXISTS "Users can update their own other costs" ON other_costs;
  DROP POLICY IF EXISTS "Users can delete their own other costs" ON other_costs;
END $$;
...
CREATE INDEX IF NOT EXISTS other_costs_created_at_idx ON other_costs(created_at);